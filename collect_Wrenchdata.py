...
def collect_one_episode(sim :WrenchSim, 
                        episode_dir,
                        meta_seed,
                        fps=10, 
                        max_steps=2000, 
...
if __name__ == "__main__":
    ...
    BASE_DIR = Path("/mnt/storage/DP_data/wrench_engagement/")/ run_time / "episodes"
    ...
    for ep in tqdm(range(NUM_EPISODES)):
        ...
        Sim = WrenchSim(p, offset=[0, 0, 0], control_dt = timeStep, seed = _seed)
