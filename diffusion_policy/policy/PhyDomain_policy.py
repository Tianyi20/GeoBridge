...
class PhyDomainPolicy(BaseImagePolicy):
    def __init__(self, 
            shape_meta: dict,
            algo_name='bc_rnn',
            obs_type='image',
...
def test():
    ...
    cfg_path = os.path.expanduser('/home/iadc/PhyDomain/diffusion_policy/diffusion_policy/config/task/PhyDomain.yaml')
    cfg = OmegaConf.load(cfg_path)
    shape_meta = cfg.shape_meta

    policy = PhyDomainPolicy(shape_meta=shape_meta)
