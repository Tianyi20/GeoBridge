...
Example:
  python MP_collectWrenchdata_fisheye.py --num-episodes 3000 --num-processes 25 --restart-every 2
...
def default_base_dir() -> Path:
    ...
    return Path("/mnt/storage/DP_data/fisheye_wrench_engagement") / run_time / "episodes"
...
def collect_episode_in_worker(
    ...
    np.random.seed(seed)
    sim = WrenchSim(client, offset=[0, 0, 0], control_dt=cfg.time_step, 
                    seed=seed, randomize_initial_ee_pose=True)
    sim.make_scene(
